...
function create() {
  ...
  game.add.text(game.world.width - 210, 10, "Lives : ", {
    font: "34px Arial",
    fill: "#fff"
  });
  ...
  for (var i = 0; i < 3; i++) {
    var ship = lives.create(game.world.width - 90 + 30 * i, 35, "ship");
...
function createAliens() {
  ...
  var alien = aliens.create(40, 50, "invader");
  ...
  var tween = game.add
    .tween(aliens)
    .to({ x: 700 }, 2000, Phaser.Easing.Linear.None, true, 0, 1000, true);

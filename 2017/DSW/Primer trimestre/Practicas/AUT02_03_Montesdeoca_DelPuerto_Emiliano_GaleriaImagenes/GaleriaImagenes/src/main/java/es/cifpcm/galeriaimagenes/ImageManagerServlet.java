    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                out.println("</head>");
                out.println("<body>");
                out.println("<h2>Galeria links</h2>");
                ...
                for (String string : fileListString) {
                    ...
                    out.println("<a href=\"" + filePath + "\">" + string + "</a>");
                }

                out.println("<h2>Galeria imagenes</h2>");

                for (String string : fileListString) {
                    String filePath = request.getContextPath()
                            + File.separator + UPLOAD_DIRECTORY + File.separator + string;
                    out.println("<img style=\"width:400px; height:300px;\" src=\"" + filePath + "\"/>");
                }
                out.println("</body>");
                out.println("</html>");
            } finally {

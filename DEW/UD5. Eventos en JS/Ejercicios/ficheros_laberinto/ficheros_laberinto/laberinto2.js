(function() {
    ...
    var bloques = laberinto.querySelectorAll('.bloque');
    ...
    inicio.addEventListener('click', function() {
        ...
        for (var i = 0; i < bloques.length; i++) {
            ...
            bloques[i].addEventListener('mouseover', function(e) {
        ...
        laberinto.addEventListener('mouseleave', function(e) {
            if (e.target) {
                if (e.target.className("bloque")) {
